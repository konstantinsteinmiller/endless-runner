    ...
    for (const prop of decl.id.properties) {
      if (prop.type === "ObjectProperty") {
        ...
        if (prop.value.type === "AssignmentPattern") {
          ...
          const rightNode = _common.unwrapTSNode.call(void 0, right);
          const withFactory = !_common.isLiteralType.call(void 0, rightNode) && !_common.isFunctionType.call(void 0, rightNode) && rightNode.type !== "Identifier";
          if (withFactory) {
